...
const TestimonialRight = ({ brand, desc, case1, case2 }) => {
  ...
  // Handle screen width detection for hiding button text and reversing stagger
  useEffect(() => {
    const handleResize = () => {
  ...
  // Handle navigation with debouncing to prevent spamming issues
  ...
  const swipeHandlers = useSwipeable({
    ...
    preventScrollOnSwipe: true, // Prevent page scrolling during swipe
  });
  ...
  const flyInVariants = {
    ...
    visible: (i) => ({
      ...
      transition: {
        ...
        delay: i * 0.15, // Stagger delay for each element
      },
    }),
  };
    ...
    <>
      <div className="w-full h-fit flex gap-9 flex-wrap justify-center relative z-2 max-[1065px]:gap-0">
        ...
        <div className="w-full max-w-md h-fit max-[1065px]:max-w-[512px] max-[581px]:max-w-full" ref={contentRef}>
          <div>
            <motion.p
              ...
              custom={0} // First item in left stagger
            >
              {brand}
            </motion.p>
            <motion.p
              ...
              initial="hidden"
              animate={isContentInView ? "visible" : "hidden"}
              custom={1} // Second item in left stagger
            >
              {desc}
            </motion.p>
          </div>
          ...
          <div className="flex flex-row flex-wrap gap-2 !mt-6 max-[1065px]:!mt-4 max-[1065px]:!mb-6">
            <motion.div
              ...
              initial="hidden"
              animate={isContentInView ? "visible" : "hidden"}
              custom={2} // Third item in left stagger
            >
            ...
            <motion.div
              ...
              initial="hidden"
              animate={isContentInView ? "visible" : "hidden"}
              custom={3} // Fourth item in left stagger
            >
        ...
        <div className="w-full max-w-lg h-fit flex flex-col gap-2 max-[1065px]:gap-[10px]" ref={mediaRef}>
          ...
          <motion.div
            ref={carouselRef}
            {...swipeHandlers} // Add swipe handlers to the carousel container
            ...
            custom={isReverseStagger ? 0 : 3} // Reverse stagger on small screens
          >
          ...
          <div className="flex flex-row justify-between order-2 min-[1065px]:order-1">
            <div className="flex flex-row gap-2 circle-none flex-wrap">
              <motion.div
                ...
                initial="hidden"
                animate={isMediaInView ? "visible" : "hidden"}
                custom={isReverseStagger ? 3 : 0} // Reverse stagger on small screens
              >
                <TestimonialButton
                  title="Testimonial"
              ...
              <motion.div
                ...
                initial="hidden"
                animate={isMediaInView ? "visible" : "hidden"}
                custom={isReverseStagger ? 2 : 1} // Reverse stagger on small screens
              >
                <TestimonialButton
                  title="Website"
                  src="images/svgs/Star.svg"
            ...
            <motion.div
              ...
              initial="hidden"
              animate={isMediaInView ? "visible" : "hidden"}
              custom={isReverseStagger ? 1 : 2} // Reverse stagger on small screens
            >
              <AnimatePresence mode="wait">
                {activeTab === "Testimonial" && (
                  <motion.div
        ...
        {activeTab === "Website" && (
          <motion.div
            ...
            animate="visible"
            exit="exit"
            className="relativy w-full h-fit bg-[var(--gray4)] border border-[var(--gray3)] rounded-[16px] !p-4 hidden max-[1065px]:block max-[1065px]:!mt-[10px]">

              <div className="flex flex-col gap-1.5">
                <TestimonialLink title="sproutmarketing.xyz" link="https://sproutmarketing.xyz" src="images/svgs/Link.svg" />
                <TestimonialLink title="citizens.sproutmarketing.xyz" link="https://citizens.sproutmarketing.xyz" src="images/svgs/Link.svg" />
              </div>
